...
class AuthSystem:
    def __init__(self, host, user, password, database):
        ...
        self._initialize_admin_tables()
        
    def _create_connection(self):
        return mysql.connector.connect(**self.db_config)
    
    def _simple_hash(self, password):
        """Basic password hashing (replace with proper hashing in production)"""
        return str(hash(password))  # Use bcrypt/scrypt in production

    def _initialize_admin_tables(self):
